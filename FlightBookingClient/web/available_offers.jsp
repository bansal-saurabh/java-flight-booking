<%-- 
    Document   : offers
    Created on : 15 Mar, 2019, 8:29:00 PM
    Author     : Saurabh Bansal
--%>

<%@page import="org.netbeans.xml.schema.offers.OfferDetails" import="java.util.*, java.lang.*"%>
...
<html lang="en">
    <head>
        ...
        <title>Available Flight Offers</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <%
                originCity = request.getParameter("source");
                destinationCity = request.getParameter("destination");
            ...
            <%
                try {
                    org.me.flightbooking.FlightBookingWS_Service flightService = new org.me.flightbooking.FlightBookingWS_Service();
                    org.me.flightbooking.FlightBookingWS port1 = flightService.getFlightBookingWSPort();

                    List<OfferDetails> result = port1.availableOffers(originCity, destinationCity, date, flightType);
            ...
            <div class="alert alert-primary" role="alert">
                <h4 class="alert-heading">List of <%= flightType%> Flights from <%= originCity%> to <%= destinationCity%> on <%= date%>:</h4>
            </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <%
                    ...
                    for (OfferDetails results : result) {
                        ...
                        try {
                            modulewebservices.CurrencyConversionWSService currencyService = new modulewebservices.CurrencyConversionWSService();
                            modulewebservices.CurrencyConversionWS port2 = currencyService.getCurrencyConversionWSPort();

                            fareValue = Math.round(port2.getConversionRate("GBP", currency) * results.getFare().getValue());
                            fareString = Double.toString(fareValue) + " " + currency;
                        } catch (Exception ex) {
                ...
                <div class="alert alert-danger" role="alert">
                    <h4 class="alert-heading">No flights found for your search query. <a href="index.jsp" class="alert-link">Try again!</a></h4>
                </div>
